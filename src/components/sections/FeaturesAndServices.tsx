...
const FeaturesAndServices: React.FC = () => {
    return (
        <>
            <section className="max-w-[1200px] mx-auto py-24 px-6 text-charcoal dark:text-white transition-colors duration-300">
                <div className="grid md:grid-cols-3 gap-12 text-center">
                    {features.map((f, i) => (
                        <div key={i} className="flex flex-col items-center">
                            <f.icon className="text-primary size-10 mb-4" />
                            <h3 className="font-bold text-xl mb-2">{f.title}</h3>
                            <p className="text-charcoal/60 dark:text-white/60 text-sm">{f.desc}</p>
                        </div>
                    ))}
                </div>
            </section>
            ...
            <section className="py-24 px-6">
                <div className="max-w-[1200px] mx-auto bg-[#f5f1ea] dark:bg-[#1d1a15] rounded-[3rem] p-12 md:p-20 text-center border border-[#e1ddd5] dark:border-[#322e28] overflow-hidden flex flex-col items-center">
                    <div className="max-w-3xl flex flex-col items-center gap-6">
                        <h2 className="text-4xl md:text-6xl font-black text-[#181511] dark:text-white mb-2 leading-tight">Interior Design Services</h2>
                        <div className="h-1.5 w-24 bg-primary rounded-full"></div>
                        <p className="text-[#86775f] dark:text-white/70 text-xl leading-relaxed mt-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full mt-10">
                            <div className="flex flex-col items-center gap-4 group">
                                ...
                                <div>
                                    <h4 className="font-black text-lg text-[#181511] dark:text-white">Complimentary Consultation</h4>
                                    <p className="text-[#86775f] dark:text-white/60 text-sm">30-minute introductory call with an expert.</p>
                                </div>
                            </div>
                            <div className="flex flex-col items-center gap-4 group">
                                <div className="size-12 rounded-2xl bg-primary/10 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-all">
                                ...
                                <div>
                                    <h4 className="font-black text-lg text-[#181511] dark:text-white">3D Visualizations</h4>
                                    <p className="text-[#86775f] dark:text-white/60 text-sm">See your dream space before you purchase.</p>
                                </div>
                            </div>
                        </div>
