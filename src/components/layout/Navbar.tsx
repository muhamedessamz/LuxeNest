        ...
        <header className="flex flex-col border-b border-solid border-primary/20 bg-background-light sticky top-0 z-50 transition-all">
            <div className="flex items-center justify-between px-6 md:px-10 py-4 w-full">
                <div className="flex items-center gap-8">
                    ...
                    <nav className="hidden md:flex items-center gap-9 text-charcoal">
                ...
                <div className="flex flex-1 justify-end gap-4 items-center">
                    <label className="hidden lg:flex flex-col min-w-40 !h-10 max-w-64">
                        <div className="flex w-full flex-1 items-stretch rounded-lg h-full overflow-hidden">
                            <div className="text-[#86775f] flex border-none bg-[#f0eeea] items-center justify-center pl-4">
                                <Search className="size-5" />
                            </div>
                            <input
                                className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden text-charcoal focus:outline-0 focus:ring-0 border-none bg-[#f0eeea] h-full placeholder:text-[#86775f] px-4 pl-2 text-base font-normal leading-normal"
